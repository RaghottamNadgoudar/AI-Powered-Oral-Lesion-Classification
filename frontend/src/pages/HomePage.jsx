    ...
    return (
        <div className="min-h-screen">
            ...
            <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
                ...
                {/* Content */}
                <div className="relative z-10 max-w-6xl mx-auto px-8 text-center pt-28">
                    {/* Badge */}
                    <div className="inline-flex items-center gap-3 bg-[#e50914]/10 border border-[#e50914]/20 rounded-full px-5 py-2.5 mb-10 animate-fade-in">
                    ...
                    {/* Headline */}
                    <h1 className="text-5xl md:text-7xl font-bold text-white mb-8 leading-tight animate-fade-in" style={{ animationDelay: '0.1s' }}>
                        Detect Oral Lesions with
                        <span className="block gradient-text">Advanced AI Technology</span>
                    </h1>

                    {/* Subtitle */}
                    <p className="text-xl text-[#b3b3b3] max-w-2xl mx-auto mb-12 animate-fade-in" style={{ animationDelay: '0.2s' }}>
                    ...
                    {/* Stats */}
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-10 mt-24 animate-fade-in" style={{ animationDelay: '0.4s' }}>
                ...
                <div className="max-w-6xl mx-auto">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mb-20">
                        {[
                            ...
                            <div
                                key={index}
                                className="glass-card p-10 hover-lift relative overflow-hidden group"
                            >
                                {/* Step Number */}
                                ...
                                <div className="relative z-10">
                                    <div className="w-14 h-14 bg-[#e50914] rounded-xl flex items-center justify-center text-white font-bold text-lg mb-8">
                                        {item.step}
                                    </div>
                    ...
                    <div className="glass-card p-10">
                        <h3 className="text-2xl font-bold text-white text-center mb-10">Classification Flow</h3>
                        <div className="flex flex-col md:flex-row items-center justify-center gap-6 md:gap-10">
                            <div className="bg-[#2a2a2a] px-8 py-5 rounded-xl text-center">
                                <div className="text-sm text-[#666] mb-2">Input</div>
                            ...
                            <div className="bg-[#e50914]/20 border border-[#e50914]/30 px-8 py-5 rounded-xl text-center">
                                <div className="text-sm text-[#e50914] mb-2">Level 1</div>
                            ...
                            <div className="bg-[#f5c518]/20 border border-[#f5c518]/30 px-8 py-5 rounded-xl text-center">
                                <div className="text-sm text-[#f5c518] mb-2">Level 2 (if unhealthy)</div>
            ...
            {/* Features Section */}
            <section className="py-32 px-8 bg-gradient-to-b from-transparent via-[#1a1a1a] to-transparent">
                <div className="max-w-6xl mx-auto">
                    <div className="text-center mb-20">
                        <h2 className="text-4xl font-bold text-white mb-6">Why Choose OralScan AI</h2>
                        <p className="text-[#b3b3b3] max-w-2xl mx-auto text-lg">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
                        {features.map((feature, index) => (
                            <div
                                key={index}
                                className="glass-card p-10 hover-lift group text-center"
                            >
                                <div className="w-16 h-16 bg-gradient-to-br from-[#e50914] to-[#b20710] rounded-xl flex items-center justify-center text-white mb-8 group-hover:scale-110 transition-transform mx-auto">
                                    {feature.icon}
                                </div>
            ...
            <section className="py-32 px-8">
                <div className="max-w-4xl mx-auto text-center">
                    <div className="glass-card p-16 glow-red">
                        <h2 className="text-4xl font-bold text-white mb-6">
                            Ready to Analyze?
                        </h2>
                        <p className="text-[#b3b3b3] mb-10 max-w-xl mx-auto text-lg">
                            Upload your first image and experience the power of AI-driven oral lesion classification.
                        </p>
                        <Link to="/analysis" className="btn-primary text-lg px-12 py-5">
                            Start Free Analysis
                        </Link>
                    </div>
                </div>
            ...
            {/* Footer */}
            <footer id="about" className="border-t border-[#2a2a2a] py-16 px-8">
                <div className="max-w-6xl mx-auto">
                    <div className="flex flex-col md:flex-row items-center justify-between gap-8">
                        <div className="flex items-center gap-4">
                            <div className="w-12 h-12 bg-gradient-to-br from-[#e50914] to-[#b20710] rounded-lg flex items-center justify-center">
